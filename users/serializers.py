    ...
    def save(self, request):
        ...
        if self.cleaned_data.get("organisation_choice") == "CREATE":
            company = Company.objects.create(
                ...
                username=self.cleaned_data.get("company_username"))
            if self.cleaned_data.get("industry_id"):
                industry = Industry.objects.filter(id=self.cleaned_data.get("industry_id")).first()
                if industry:
