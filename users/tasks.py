...
def login_notification_email(first_name, email):
    ...
    mail.send(
        ...
        html_message=f"<h2>Hi {first_name},</h2> <p>We have detected a new login to your Leadboard App account as at"
                     ...
                     f"<a href='mailto:{LEADBOARD_INFO_MAIL}'>{LEADBOARD_INFO_MAIL}</a></p>",
        priority='now',
    )
    return True
